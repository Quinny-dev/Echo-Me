...
- **Letters**: a, b, c, d, e, f, g, h, i, k, j, z
- **Words**: you, me, my, hello, like, apple, orange, pear, name
...
[Refer to the Setup Guide for virtual environment startup](setup\SETUP_GUIDE.md)
...
*A Capstone project developed in the third year of the Bachelor of Computing program, focused on creating inclusive technology for the Deaf and Hard-of-Hearing community.*