"""
Quick fix for GPU compatibility issues - forces CPU mode
Replace your corrector.py with this version
"""
...
class GrammarCorrector:
        ...
        if device is None:
            ...
            if torch.cuda.is_available():
                try:
                    ...
                    logger.info("CUDA compatible - using GPU")
                except Exception as e:
                    logger.warning(f"CUDA incompatible ({e}), falling back to CPU")
    ...
    def correct_batch(self, rough_texts: List[str]) -> List[Dict[str, any]]:
        ...
        batch_size = 2 if self.device.type == 'cpu' else 4  # Smaller batches for CPU
